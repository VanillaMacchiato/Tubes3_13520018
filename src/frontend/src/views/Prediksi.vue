<template>
  ...
  <div class="card">
    ...
    <input type="text" id="fname" v-model="namapengguna" name="namapengguna" placeholder="Pengguna...">
    </div>
    <div class="box2">
    ...
    <input type="text" id="fname" v-model="namapenyakit" name="namapenyakit" placeholder="Penyakit...">
    </div>
    </div>
